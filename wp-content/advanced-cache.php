...
$possible_plugin_locations = array(
	...
	'C:\wamp64\www\la_maison_des_etudiants\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/la_maison_des_etudiants/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\wamp64\www\la_maison_des_etudiants\wp-content\plugins\wp-optimize\cache/extensions');
}
