...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$theme_maison_des_etudiants_description = get_bloginfo( 'description', 'display' );
			if ( $theme_maison_des_etudiants_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $theme_maison_des_etudiants_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
